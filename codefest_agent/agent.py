...
def run_agent(query):
    ...
    # Step 2 — Search
    search_results = search_businesses(query, max_results=10)
    ...
    # Step 4 — Deduplicate
    businesses, duplicate_count = deduplicate(businesses)

    # Step 5 — Verify
    businesses = verify_all(businesses)

    # Step 6 — Save to cache
    save_to_cache(query, businesses)
